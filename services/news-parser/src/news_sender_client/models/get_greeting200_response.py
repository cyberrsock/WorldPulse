...
class GetGreeting200Response(BaseModel):
    ...
    news_sender_specific_thing: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["message", "currentTime", "news_sender_specific_thing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "news_sender_specific_thing": obj.get("news_sender_specific_thing")
        })
        return _obj
